...
| ID | Task | Status | Ticket |
|----|------|--------|--------|
| 201 | Matchup Center - API endpoints | NOT_STARTED | [201-matchup-api.md](tasks/201-matchup-api.md) |
...
| ID | Task | Status | Ticket |
|----|------|--------|--------|
| 301 | AI Chat - Streaming API endpoint | NOT_STARTED | [301-chat-api.md](tasks/301-chat-api.md) |
