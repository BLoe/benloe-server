...
/** A goal's target_value by fuzzy title match — real-ish in the absence of a stricter goal→metric link. */
function goalTarget(db: Database.Database, domain: string, titleLike: string, fallback: number): number {
  const row = db
