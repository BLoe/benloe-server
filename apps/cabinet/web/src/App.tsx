...
/** The v2 console: the shell + surface routing. Chat is a surface (Chat),
...
export default function App() {
  ...
  // A conversation opened from the command bar: a chat + a first message to send.
