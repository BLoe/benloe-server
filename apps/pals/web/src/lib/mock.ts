...
const ops: OpsFeed = {
  entries: [
    { id: 'o1', at: '2026-07-08T05:41:00-04:00', tool: 'backup', action: 'snapshot databases', reason: 'nightly maintenance', tier: 3, kind: 'cron', result: 'pals.db + episodic.db · integrity ok', threadId: null, reversible: false },
    { id: 'o2', at: '2026-07-08T05:41:20-04:00', tool: 'mcp__pals__search_episodic', action: 'index 2 journal entries', reason: 'embedding backfill', tier: 4, kind: 'cron', result: '2 indexed', threadId: null, reversible: false },
    { id: 'o3', at: '2026-07-08T02:14:00-04:00', tool: 'Write', action: 'title thread', reason: 'auto-title untitled thread', tier: 4, kind: 'heartbeat', result: '"PALS Systems Status Report"', threadId: 't-5dd8', reversible: true, diff: 'title: null → "PALS Systems Status Report"' },
  ],
};
...
const threads: ThreadSummary[] = [
  { id: 't-5dd8', title: 'PALS Systems Status Report', model_override: null, archived: 0, updated_at: '2026-07-07T13:10:00-04:00', messages: 6, preview: 'Full status check across services and data.' },
